...
const lines = [
  { command: '> agent.authenticate()', result: '✓ verified', delay: 0 },
  { command: '> agent.callTool("addToCart", {id: "E001"})', result: '✓ authorized', delay: 800 },
  { command: '> agent.getSession()', result: '✓ context loaded', delay: 1600 },
]
  ...
  return (
    ...
    >
      ...
      <div className="bg-code-bg rounded-xl border border-border-glow-30 overflow-hidden shadow-2xl shadow-border-glow/10">
        ...
        {/* Terminal body */}
        <div className="p-5 font-mono text-sm leading-relaxed min-h-[140px]">
